...
function useTrackElements(_ref) {
  ...
  react.useEffect(function () {
     warning(ResizeObserver, "This browser does not support ResizeObserver out of the box. We recommend to add a polyfill in order to utilize the full capabilities of react-laag. See: https://link") ;
  ...
  react.useEffect(function () {
    ...
    return possibleRegisterFn({
      ...
      closeChild: function closeChild() {
         warning(onParentClose, "react-laag: You are using useLayer() in a nested setting but forgot to set the 'onParentClose()' callback in the options. This could lead to unexpected behavior.") ;
...
function setGlobalContainer(container) {
  if (typeof document === "undefined") {
   ...
   warning(!(GLOBAL_CONTAINER instanceof HTMLElement), "react-laag: You've called 'setGlobalContainer() previously'. It is recommended to only set the global container once, otherwise this may lead to unexpected behaviour.") ;
  ...
  if (typeof container === "function") {
   ...
   warning(GLOBAL_CONTAINER instanceof HTMLElement, "react-laag: You've called 'setGlobalContainer()', but it didn't result in a valid html-element") ;
}
var DEFAULT_OPTIONS = {
  auto: false,
  arrowOffset: 0,
